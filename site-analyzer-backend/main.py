...
async def get_parcel_boundary(lat: float, lng: float) -> Optional[List[tuple]]:
    ...
    """
    try:
        # Try Salt Lake County's public GIS services
        # Using their MapServer endpoint for parcels
        url = "https://services1.arcgis.com/99lidPhWCzftIe9K/arcgis/rest/services/SLCo_Parcels_Public/FeatureServer/0/query"
