...
async def analyze_site(request: AddressRequest) -> SiteReport:
    ...
    try:
        ...
        elevation_data, parcel_data, flood_data, wetlands_data, soil_data = await asyncio.gather(
            elevation_task, parcel_task, flood_task, wetlands_task, soil_task,
...
def generate_comprehensive_pdf(address: str, lat: float, lng: float,
                              ...
                              utilities_assessment: Dict, risk_score: int) -> str:
